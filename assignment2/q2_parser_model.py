...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(dtype = tf.int32, shape = (None, self.config.n_features), name = 'features')
    ...
    def add_prediction_op(self):
        ...
        b1 = tf.get_variable(name = 'b1', shape = None, initializer = tf.zeros((self.config.hidden_size,)))
        b2 = tf.get_variable(name = 'b2', shape = None, initializer = tf.zeros((self.config.n_classes,)))
...
def main(debug=False):
    ...
    with tf.Session(graph=graph) as session:
        ...
        if not debug:
            ...
            print ("Final evaluation on test set",UAS, dependencies)
