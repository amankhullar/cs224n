...
class GRUCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            b_z = tf.get_variable(name = "b_z", initializer = tf.zeros(shape = [self.state_size, ]))
            ...
            b_r = tf.get_variable(name = "b_r", initializer = tf.zeros(shape = [self.state_size, ]))
            ...
            b_o = tf.get_variable(name = "b_o", initializer = tf.zeros(shape = [self.state_size, ]))
